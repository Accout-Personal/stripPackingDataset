...
#MaxStableSets = [0,525,1292,1602,2102,2960,3329,3928,4118,5156,5353,5996,6607,8038,8232,9164]
#MaxStableSets = [0,525,1060,1755,2383,2607,3477,3694,4364,5193,5829,6020,7291,8090,8229,9564]
MaxStableSets = [9,20,41]
MaxStableSets = [1,35,51]
datasetname = 'three'

dir_path = os.path.dirname(os.path.realpath(__file__))
datasetpath = dir_path+'\\'+datasetname+'\\'
